...
public class PlayerInventoryController : MonoBehaviour
{
   ...
   public static void Drop()
   {
      ...
      {
         _itemsInHands[0].Drop((playerTransform.position + playerTransform.forward * dropForce + new Vector3(0,2,0)));
   ...
   private void OnDrawGizmos()
   {
      ...
      Gizmos.DrawSphere(playerTransform.position + playerTransform.forward * dropForce + new Vector3(0,2,0),
                        0.2f);
   }
}