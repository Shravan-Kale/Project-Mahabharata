...
public class PlayerCombatController : MonoBehaviour
{
   ...
   public void Attack()
   {
      ...
      void SetUpWeapon()
      {
         _damage2Deal = _weapon.weaponComboChains[_weapon.comboChain]
                               .weaponComboChain[_weapon.currentComboIndex]
                               .damage;
         _currenAttackCd = _weapon.weaponComboChains[_weapon.comboChain]
                                  .weaponComboChain[_weapon.currentComboIndex]
                                  .attackSpeed;
      }
      ...
      void DoBowDamage()
      {
         ...
         //     _bowController.weaponComboChains[0].animationsStateName); // TODO: mb make bow combo
      }
   }
